const sonido = new Audio('../../../../../../../media/ding.mp3');
...
function insertContent(socialMedia){
    ...
    let row3 = {label: "unset value", text: "unset value", isLink: false}
    let row4 = {label: "unset value", text: "unset value", isLink: false}
    ...
    switch(socialMedia){
        ...
        case "Playlist":
            isDoubleLink = false;
            row1.label = "Mi Playlist:";
            row1.text = "https://open.spotify.com/playlist/7GKuFLN4uf5w8Zv7HTw3M7";
            row1.isLink = true;
    ...
    <div class="howeverThatBarNames">
        <label>
            <img src="../../../../../../../media/icons/98/${socialMedia}.png" width="16px" height="16px" style="position: relative; top: 2px;">
    ...
    <div class="howeverThatBarNames">
        <label>
            <img src="../../../../../../../media/icons/98/Discord.png" width="16px" height="16px" style="position: relative; top: 2px;">
